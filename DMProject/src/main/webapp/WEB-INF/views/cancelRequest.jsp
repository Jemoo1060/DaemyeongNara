...
<body>
    ...
    <section id="main_section">
        <div id="mainCenter"> 
            <div id="mainContent1">
                <img id="checkicon" src = "${path}/resources/images/checked.png">
                <h1 id="cancelmainfont">주문 취소 신청 되었습니다</h1>
                <div id="cancelButtonBox">
                    <input id="cancelButton" type="button" value="취소현황확인" onclick="document.location.href='orderInfo?mbrCode=${mbrCode}'">
