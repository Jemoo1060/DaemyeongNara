    ...
    <div class="content-box">
      ...
      <div id="main">
        ...
        <div style="margin-top: 100px; margin-left: 10px;">
          <a href="#"><img src="${path}/resources/images/info.png"></a>
        </div>
        ...
        <div class="table_box" style="margin-top: 45px;">
	            	...
	            	<c:forEach var = "cnt" begin = "0" end = "${bbList.size()-1}">
		            	<tr>
			                ...
			                <td class="notice_title">
			                  <a href="info_boardContent?bbiCode=${bbiCode}&bbNum=${bbList[cnt].bbNum}&mbrCode=${mbrList[cnt].mbrCode}&pageNo=${pageNo}&cutPageNo=${cutPageNo}">${bbList[cnt].bbTitl}</a>
			                </td>
			                <td>관리자</td>
			                <th>${dateList[cnt]}</th>
          ...
          <section style="position: relative;">
            <div style="margin-top: 30px;">
	            <c:if test="${mbrGrade == '0101'}">
	            	<input id="write_button" type="button" value="게시글작성" onclick="document.location.href='bbInputPage?bbiCode=${bbiCode}'">
	            </c:if>
            </div>
          </section>
          <div class="paging">
