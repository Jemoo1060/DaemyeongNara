	...
	$('#breakawayBtn').click(function(){
		...
		if(!result){
			return false;
			  ...
			  location.replace('breakawayDone?mbrCode=${memberDto.mbrCode}');
		}
	});
});
</script>
...
<body>
    ...
    <section id="main_section">
        <div id="mainContent">
            <h1 id="cstInquirymainfont"> 회원 정보 조회</h1>
                <table id="cstInfoTable">
                    <tr>
                        <th>아이디</th>
                    ...
                    <tr>
                        <th>대명초등학교 회원</th>
                        <td>${schulGradeClass}</td>
                    </tr>
                </table>
                <div id="cstInquirybuttoninput">
                    <input type="button" value="수정" onclick="document.location.href='cstInfoUpdatePage?mbrCode=${memberDto.mbrCode}'">
                    <input id="breakawayBtn"type="button" value="회원탈퇴" >
                </div>
        </div>
    </section>
