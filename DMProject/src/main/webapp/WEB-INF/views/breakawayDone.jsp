...
<body>
    ...
    <section id="main_section">
        <div id="mainCenter"> 
            <div id="mainContent1">
                <img id="checkImg" src = "${path}/resources/images/checked.png">
                <h1 id="breakawaymainfont">탈퇴되었습니다</h1>
                <input id ="breakawayhomeButton" type="button" value="홈으로 이동" onclick="document.location.href='main'">
            </div>
        </div>
    </section>
