          ...
          <section style="margin-top: 30px; margin-left: 10px;">
           ...
           <section id="button" style="position: relative;">
             <div style="margin-top: 30px;">
              ...
              <input type="button" value="수정 취소" onclick="document.location.href='info_boardContent?bbiCode=${bbDto.bbiCode}&bbNum=${bbDto.bbNum}&pageNo=${pageNo}&cutPageNo=${cutPageNo}'">
             </div>
           </section>
          </form> 
          </div>
