            	...
            	<c:when test="${bbList.size() > 0}">
	            	<c:forEach var = "cnt" begin = "0" end = "${bbList.size()-1}">
		            	<tr>
			                ...
			                <c:choose>
			                	<c:when test="${bbList[cnt].bbOthbcAt == 'T'.charAt(0)}">
			                	...
			                	<c:otherwise>
			                		<td class="notice_title">
			                  			...
			                  			<input id="pwdInput_${bbList[cnt].bbNum}_${mbrList[cnt].mbrId}" type = "text" style = "width : 90px; height:20px;" placeholder="숫자 4자리" maxlength="4">
