  ...
  <div id="body">
    <div class="content-box">
      ...
      <div id="main">
        ...
        <div class="paging">
            <a id="preButton" href="prdSearch?prdName=${prdName}&pageNo=${cutPageNo-1}&cutPageNo=${cutPageNo-5}">&#60;</a>
            <c:choose>
            	<c:when test="${maxPage > cutPageNo+4}">
            		<c:forEach var = "i" begin ="${cutPageNo}" end="${cutPageNo+4}">
            			<a href="prdSearch?prdName=${prdName}&pageNo=${i}&cutPageNo=${cutPageNo}" id="pageNo${i}" class="num">${i}</a>
            		</c:forEach>
            	</c:when>
            	<c:otherwise>
            ...
            <a id="nextButton" href="prdSearch?prdName=${prdName}&pageNo=${cutPageNo+5}&cutPageNo=${cutPageNo+5}">></a>
          </div> 
