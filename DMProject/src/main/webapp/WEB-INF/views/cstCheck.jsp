...
<body>
	...
	<section id="main_section">
        <div id="mainContent">
            <h1 id="cstCheckmainfont"> 회원 정보 확인</h1>
            <h4 id="cstCheckinfoCheck">회원님의 정보를 안전하게 보호 하기 위해 비밀번호를 다시 한번 확인 합니다.</h4>
            <form action="cstInfoCheck" method ="post">
            	<input type="hidden" name="mbrId" value = "${id}"/>
                <table id="cstTable">
                    <tr>
                        <th>아이디</th>
                        <td>${id}</td>
                    ...
                    <tr>
                        <th>비밀번호</th>
                        <td><input id="passwordInput" type="password" name="mbrPwd" placeholder="비밀번호 입력"/></td>
                    </tr>
                </table>
                <div id="cstCheckbuttoninput">
                        <input id="submitBtn" type="submit" value="확인">
                        <input  type="button" value="취소" onclick="document.location.href='main'">
                </div>
            </form>
        </div>
    </section>
