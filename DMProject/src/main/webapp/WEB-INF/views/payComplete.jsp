...
<link href="${path}/resources/css1/pay_complete.css" type="text/css" rel="stylesheet">
    ...
    <div class="content-box">
      ...
      <div id="main">
        ...
        <div style="margin-top: 100px;">
          <img src="${path}/resources/images/checked.png">
        </div>
        ...
        <section>
          <input id="button1" style="margin-right: 40px;" type="button" value="주문 내역확인" onclick="location.href='orderInfo?mbrCode=${mbrCode}'">
          <input id="button2" type="button" value="홈으로 이동" onclick='location.href="main"'>
        </section>
