	            	...
	            	<c:forEach var = "cnt" begin = "0" end = "${bbList.size()-1}">
		            	<tr>
			                ...
			                <td class="notice_title">
			                  <a href="info_boardContent?bbiCode=${bbiCode}&bbNum=${bbList[cnt].bbNum}&writerId=${mbrList[cnt].mbrId}&pageNo=${pageNo}&cutPageNo=${cutPageNo}&chk=${chk}">${bbList[cnt].bbTitl}</a>
			                </td>
