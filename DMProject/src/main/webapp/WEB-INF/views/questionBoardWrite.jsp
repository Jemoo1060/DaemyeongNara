...
<body>
    ...
    <div id="body">
        ...
        <div id= "main">
          ...
          <form action = "bbInput" method="get">
	          <input type ="hidden" name = "bbiCode" value="${bbiCode}">
	          <input type ="hidden" name = "mbrCode" value="${mbrCode}">
	          <input type ="hidden" name = "prdCode" value="${productDto.prdCode}">
	          <input type ="hidden" name = "prdName" value="${productDto.prdName}">
          <section style="margin-top: 30px; margin-left: 10px;">
              <table border="1">
                <tr id="tr1">
                  <td style="width: 70px; background-color: #98bcff;">제목</td>
                  <td style="width: 700px;">
                      <input id="titlInput" type="text" name="bbTitl" style="width: 600px; border: transparent;" placeholder="${productDto.prdName}">
                  </td>
                </tr>
                <tr>
                	<td style="width: 70px; background-color: #98bcff;">내용</td>
                  <td  style="height: 200px;">
                    <textarea id="cnInput"  name="bbCn" style="width: 570px; height: 300PX; border: transparent;"></textarea>
                  </td>
                </tr>
                <tr>
            ...
            <input id="radio1" type="radio" name="bbOthbcAt" value="Y" checked>
            <label for="bbOthbcAt">공개</label>
            <input id="radio2" type="radio" name="bbOthbcAt" value="N">
            <label for="bbOthbcAt">비공개</label>
              <span id="pwdText">비밀번호</span>
              <input id="pwdInput" type="password" name="bbPwd" name="bbPwd" maxlength="4" placeholder="숫자 4자리 입력" pattern="[0-9]+">  
           </section>
			

           <section id="button" style="position: relative;">
             <div style="margin-top: 30px;">
              <input id = "submitButton" type="submit" value="작성완료">
              <input type="button" value="작성 취소" onclick="document.location.href='info_boardList?bbiCode=${bbiCode}'">
             </div>
           </section>
          </form> 
        </div>
